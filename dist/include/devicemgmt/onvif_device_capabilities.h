...
typedef struct _OnvifDeviceIOCapabilities OnvifDeviceIOCapabilities;

SHARD_EXPORT OnvifMedia * OnvifCapabilities__get_media(OnvifCapabilities * self);
SHARD_EXPORT OnvifDeviceIOCapabilities * OnvifCapabilities__get_deviceio(OnvifCapabilities * self);
...
SHARD_EXPORT char * OnvifDeviceIOCapabilities__get_address(OnvifDeviceIOCapabilities * self);
SHARD_EXPORT int OnvifDeviceIOCapabilities__get_videoSources(OnvifDeviceIOCapabilities * self);
SHARD_EXPORT int OnvifDeviceIOCapabilities__get_videoOutputs(OnvifDeviceIOCapabilities * self);
SHARD_EXPORT int OnvifDeviceIOCapabilities__get_audioSources(OnvifDeviceIOCapabilities * self);
SHARD_EXPORT int OnvifDeviceIOCapabilities__get_audioOutputs(OnvifDeviceIOCapabilities * self);
SHARD_EXPORT int OnvifDeviceIOCapabilities__get_relayOutputs(OnvifDeviceIOCapabilities * self);
