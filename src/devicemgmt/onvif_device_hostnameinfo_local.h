#ifndef ONVIF_DEV_HOST_INFO_LOCAL_H_ 
#define ONVIF_DEV_HOST_INFO_LOCAL_H_
...
OnvifDeviceHostnameInfo * OnvifDeviceHostnameInfo__new(struct _tds__GetHostnameResponse * response);
