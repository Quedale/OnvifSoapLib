#ifndef ONVIF_MEDIA2_AUDIO_OUTPUT_CONFIG_OPTIONS_LOCAL_H_ 
#define ONVIF_MEDIA2_AUDIO_OUTPUT_CONFIG_OPTIONS_LOCAL_H_
...
OnvifMedia2AudioOutputConfigOptions * OnvifMedia2AudioOutputConfigOptions__new(struct _ns1__GetAudioOutputConfigurationOptionsResponse * resp);
